...
'fa-z',
  ...
  function onClick(type: string, evt: React.MouseEvent) {
    ...
    navigator.clipboard.writeText(text).then(function() {
      console.warn("Copied to clipboard successfully!");
    }, function() {
          ...
          filterIcons.map((icon) => {
            return (
              <div onClick={onClick.bind(null, icon)} title={icon.substring(3)} style={{padding: '0 10px', width: '80px', textAlign: 'center' }} key={icon}>
                <p>
                  <Icon size='medium' type={icon.substring(3)}></Icon>
                </p>
                <p style={{color: '#ccc', fontSize: '0.5rem', overflowX: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>{icon.substring(3)}</p>
              </div>
            )
          })
        }
